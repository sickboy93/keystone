...
def downgrade(migrate_engine):
    ...
    ForeignKeyConstraint(columns=[role_organization_table.c.organization_id], refcolumns=[project.c.id], name='role_user_fiware_ibfk_2', ondelete='CASCADE').drop()    
    ForeignKeyConstraint(columns=[role_organization_table.c.organization_id], refcolumns=[project.c.id], name='role_user_fiware_ibfk_2').create()    
